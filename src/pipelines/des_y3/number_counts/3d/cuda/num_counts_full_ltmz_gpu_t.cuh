...
// shift), whereas the CPU full_ltmz backend uses MOR_HOD_t
...
// pinned in test/num_counts_full_ltmz_gpu.test.cu.
//
...
#ifndef Y3_CLUSTER_CPP_NUM_COUNTS_FULL_LTMZ_GPU_T_CUH
#define Y3_CLUSTER_CPP_NUM_COUNTS_FULL_LTMZ_GPU_T_CUH
