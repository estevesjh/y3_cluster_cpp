...
// this code contains all functions for selection bias calculation: 
//                - richness-to-physical-radius conversion R_lambda, 
//                - angular radius theta_lob, 
//                - sigmoid weighting, 
//                - and b_sel asymptote computation.
//
