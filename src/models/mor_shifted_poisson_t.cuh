...
// This is the continuous shifted-Poisson form, NOT the Costanzi-2019
// skewed-Gaussian used by MOR_DES_LOG_t.
//
// Formula:
...
//
// This is continuous in ltr (no Poisson-k sum, no Gaussian convolution).
