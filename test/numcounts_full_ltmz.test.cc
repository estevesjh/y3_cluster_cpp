...
#include "pipelines/des_y3/observables/number_counts/full_ltmz/cpp/num_counts_full_ltmz_t.hh"
...
TEST_CASE("NumCountsFullLtmz: K_i/K_j richness and photo-z kernels match an "
...
TEST_CASE("NumCountsFullLtmz: MOR_HOD_t shifted-Poisson matches an "
...
TEST_CASE("NumCountsFullLtmz: operator() equals the documented product of "
          "HMF * dV/dOdz * Omega(z) * K_j * K_i * P_HOD")
{
  // Config: one richness/photo-z bin.
  cosmosis::DataBlock cfg;
  cfg.put_val("NumCountsFullLtmz", "lam_min", std::vector<double>{20.0});
  cfg.put_val("NumCountsFullLtmz", "lam_max", std::vector<double>{30.0});
  cfg.put_val("NumCountsFullLtmz", "zob_min", std::vector<double>{0.25});
  cfg.put_val("NumCountsFullLtmz", "zob_max", std::vector<double>{0.45});
  cfg.put_val("NumCountsFullLtmz", "sigma_z", std::vector<double>{0.02});
  NumCountsFullLtmz model(cfg);
  ...
  // in NumCountsFullLtmz::operator() would show up as a mismatch here even
...
TEST_CASE("NumCountsFullLtmz: bin selection and support-boundary invariants")
{
  cosmosis::DataBlock cfg;
  cfg.put_val("NumCountsFullLtmz", "lam_min", std::vector<double>{15.0, 50.0});
  cfg.put_val("NumCountsFullLtmz", "lam_max", std::vector<double>{25.0, 70.0});
  cfg.put_val("NumCountsFullLtmz", "zob_min", std::vector<double>{0.15, 0.40});
  cfg.put_val("NumCountsFullLtmz", "zob_max", std::vector<double>{0.30, 0.55});
  cfg.put_val("NumCountsFullLtmz", "sigma_z", std::vector<double>{0.025, 0.03});
  NumCountsFullLtmz model(cfg);
  ...
  // num_counts_full_ltmz_t.hh::set_grid_point.
...
TEST_CASE("NumCountsFullLtmz: operator() matches a second, fully-independent "
          "closed-form fixture (Einstein-de Sitter, exact-bilinear HMF)")
{
  cosmosis::DataBlock cfg;
  cfg.put_val("NumCountsFullLtmz", "lam_min", std::vector<double>{2.0});
  cfg.put_val("NumCountsFullLtmz", "lam_max", std::vector<double>{4.5});
  cfg.put_val("NumCountsFullLtmz", "zob_min", std::vector<double>{0.2});
  cfg.put_val("NumCountsFullLtmz", "zob_max", std::vector<double>{0.5});
  cfg.put_val("NumCountsFullLtmz", "sigma_z", std::vector<double>{0.05});
  NumCountsFullLtmz model(cfg);
